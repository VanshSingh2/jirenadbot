...
BOT_CONFIG = {
    ...
    'bot_token': os.getenv('BOT_TOKEN', '8468153395:AAHNPc8mmxRw6LLPOzgtHiRE04Zm6TGBCv0'),
    ...
    'logger_bot_token': os.getenv('LOGGER_BOT_TOKEN', '8544461885:AAGzox0JA_3ZKKJeoPxjOjuvpBQzoJzwbE8'),
